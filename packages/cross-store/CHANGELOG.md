...
Documentation-only patch. **No source changes** — published so the npm package page documents
`requiredScopeColumns` (added in 0.2.1) and why it makes tenant isolation fail closed.
